      ...
      <table className="w-full text-left">
        <thead className="bg-dark-card border-b border-dark-border">
          <tr>
            {showMovieInfo && (
              <>
                <th className="px-2 md:px-6 py-4 text-gray-400 font-semibold uppercase tracking-wide text-sm">
                  Movie
                </th>
                <th className="px-2 md:px-6 py-4 text-gray-400 font-semibold uppercase tracking-wide text-sm">
                  Poster
                  ...
                  <td className="px-2 md:px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div>
                        ...
                        <div className="text-gray-500 text-sm">{review.displayName != "Anonymous" && "Verified"}</div>
                      </div>
                    </div>
                  </td>
                  <td className="px-2 md:px-6 py-4">

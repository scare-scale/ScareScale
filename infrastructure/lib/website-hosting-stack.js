    ...
    constructor(scope, id, props) {
        ...
        ***REMOVED***;
        ...
        const cloudfrontFunction = new aws_cloudfront_1.Function(this, `function`, {
            code: aws_cloudfront_1.FunctionCode.fromInline('function handler(r){var e=r.request,i=e.uri;return i.endsWith("/")?e.uri+="index.html":i.includes(".")||(e.uri+=".html"),e***REMOVED***')
        ***REMOVED***);
        ...
        ***REMOVED***;
        const distribution = new aws_cloudfront_1.Distribution(this, `distribution`, {
            ...
            defaultBehavior: {
                origin: new aws_cloudfront_origins_1.S3Origin(bucket, { originAccessIdentity ***REMOVED***),
